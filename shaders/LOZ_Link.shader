...
models/players/link/legs_oot
{
    ...
    {
        map models/players/link/legs_oot
        blendFunc GL_ONE GL_ONE_MINUS_SRC_ALPHA
        rgbGen lightingDiffuse
    }
}
...
models/players/link/accessories_oot
{
	q3map_material	Fabric
    {
        map textures/colors/gray
    ...
    {
        map models/players/link/accessories_oot
        blendFunc GL_ONE GL_ONE_MINUS_SRC_ALPHA
        rgbGen lightingDiffuse
    }
    {
        map models/players/link/oot_accessories_s
        blendFunc GL_SRC_ALPHA GL_ONE
        detail
        alphaGen lightingSpecular
    }
...
models/players/link/parts
{
    ...
    {
        map models/players/link/parts_s
        blendFunc GL_SRC_ALPHA GL_ONE
        glow
        detail
        alphaGen lightingSpecular
